/*
    ...
    Existen 4 eventos en las transiciones
        * transitionrun:
         Se dispara cuando se carga la transición
        * transitionstart: 
          Se dispara cuando se inicia la transición
        * transitioncancel: 
          Se dispara cuando se cancela la transición
        * transitionend: 
          Se dispara cuando se termina la transición
*/
