/*
  https://developer.mozilla.org/en-US/docs/Web/API/Animation
    ...
    Existen 4 eventos principales en las animaciones
        * animationstart: 
          Se dispara cuando se inicia la animación
        *animationiteration: 
          Se dispara cada vez que se inicia de nuevo el ciclo de la animación
        *animationcancel: 
          Se dispara cuando se cancela la animación
        * animationend: 
          Se dispara cuando se termina la animación
*/
